...
# Load the data
load(paste0("/scratch/yc4178/MTL-MICE/data/uselection/bystate_2020/mar_0.3/uselect_mar_",task.id, ".RData"))
...
file.name <- paste0("/scratch/yc4178/MTL-MICE/rda/output_0.3/uselect_imp","_", task.id, ".RData")
