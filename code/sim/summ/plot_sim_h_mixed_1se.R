...
file_names <- dir(path = "/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed", pattern = "*.RData")
numbers <- na.omit(as.numeric(gsub("^h_mixed_1se_h0_([0-9]+)\\.RData$", "\\1",file_names)))
...
for(i in numbers){
  ...
  file_name <- paste0("/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed/h_mixed_1se_h0","_", i, ".RData")
  load(file_name) 
...
file_names <- dir(path = "/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed", pattern = "*.RData")
numbers <- na.omit(as.numeric(gsub("^h_mixed_1se_h0\\.25_([0-9]+)\\.RData$", "\\1",file_names)))
...
for(i in numbers){
  ...
  file_name <- paste0("/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed/h_mixed_1se_h0.25","_", i, ".RData")
  load(file_name) 
...
file_names <- dir(path = "/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed", pattern = "*.RData")
numbers <- na.omit(as.numeric(gsub("^h_mixed_1se_h0\\.5_([0-9]+)\\.RData$", "\\1",file_names)))
...
for(i in numbers){
  ...
  file_name <- paste0("/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed/h_mixed_1se_h0.5","_", i, ".RData")
  load(file_name) 
...
file_names <- dir(path = "/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed", pattern = "*.RData")
numbers <- na.omit(as.numeric(gsub("^h_mixed_1se_h0\\.75_([0-9]+)\\.RData$", "\\1",file_names)))
...
for(i in numbers){
  ...
  file_name <- paste0("/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed/h_mixed_1se_h0.75","_", i, ".RData")
  load(file_name) 
...
file_names <- dir(path = "/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed", pattern = "*.RData")
numbers <- na.omit(as.numeric(gsub("^h_mixed_1se_h1_([0-9]+)\\.RData$", "\\1",file_names)))
...
for(i in numbers){
  ...
  file_name <- paste0("/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed/h_mixed_1se_h1","_", i, ".RData")
  load(file_name) 
...
file_names <- dir(path = "/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed", pattern = "*.RData")
numbers <- na.omit(as.numeric(gsub("^h_mixed_1se_h1\\.25_([0-9]+)\\.RData$", "\\1",file_names)))
...
for(i in numbers){
  ...
  file_name <- paste0("/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed/h_mixed_1se_h1.25","_", i, ".RData")
  load(file_name) 
...
file_names <- dir(path = "/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed", pattern = "*.RData")
numbers <- na.omit(as.numeric(gsub("^h_mixed_1se_h1\\.5_([0-9]+)\\.RData$", "\\1",file_names)))
...
for(i in numbers){
  ...
  file_name <- paste0("/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed/h_mixed_1se_h1.5","_", i, ".RData")
  load(file_name) 
...
file_names <- dir(path = "/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed", pattern = "*.RData")
numbers <- na.omit(as.numeric(gsub("^h_mixed_1se_h1\\.75_([0-9]+)\\.RData$", "\\1",file_names)))
...
for(i in numbers){
  ...
  file_name <- paste0("/Users/yuyuchen/Library/CloudStorage/Dropbox/New York University/Research/Feng Lab/MTL-MICE/sim/output/htrends_mixed/h_mixed_1se_h1.75","_", i, ".RData")
  load(file_name) 
...
output_mtlmice_pool_h1.75 <- Filter(function(x) !is.character(x), mtlmice_pool_list) %>% 
  Filter(function(x) !is.null(x), .)  
output_mtlmice_h1.75 <- Filter(function(x) !is.character(x), mtlmice_list) %>% 
  Filter(function(x) !is.null(x), .) 
output_mtlmice0_h1.75 <- Filter(function(x) !is.character(x), mtlmice0_list) %>% 
  Filter(function(x) !is.null(x), .) 
output_mice_h1.75 <- Filter(function(x) !is.character(x), mice_list) %>% 
  Filter(function(x) !is.null(x), .) 
output_mice_pool_h1.75 <- Filter(function(x) !is.character(x), mice_pool_list) %>% 
  Filter(function(x) !is.null(x), .) 

output_mtlmice_pool_sum_h1.75 <- summarize_mtlmice_pool(output_mtlmice_pool_h1.75, method = "mtlmice_pool", iterations = length(numbers))
output_mtlmice_sum_h1.75 <- summarize_mtlmice_pool(output_mtlmice_h1.75, "mtlmice", iterations = length(numbers))
output_mtlmice0_sum_h1.75 <- summarize_mtlmice_pool(output_mtlmice0_h1.75, "mtlmice0", iterations = length(numbers))
output_mice_sum_h1.75 <- summarize_mtlmice_pool(output_mice_h1.75, "mice", iterations = length(numbers))
output_mice_pool_sum_h1.75 <- summarize_mtlmice_pool(output_mice_pool_h1.75, "mice_pool", iterations = length(numbers))


output_continuous_summary_h1.75 <- rbind(output_mtlmice_pool_sum_h1.75$Continuous,
                                       output_mtlmice_sum_h1.75$Continuous, 
                                       output_mtlmice0_sum_h1.75$Continuous, 
                                       output_mice_sum_h1.75$Continuous,
                                       output_mice_pool_sum_h1.75$Continuous)

output_coeff_summary_h1.75 <- rbind(output_mtlmice_pool_sum_h1.75$Coefficients,
                                       output_mtlmice_sum_h1.75$Coefficients, 
                                       output_mtlmice0_sum_h1.75$Coefficients, 
                                       output_mice_sum_h1.75$Coefficients,
                                       output_mice_pool_sum_h1.75$Coefficients)

output_categorical_summary_h1.75 <- rbind(output_mtlmice_pool_sum_h1.75$Categorical, 
                                        output_mtlmice_sum_h1.75$Categorical, 
                                        output_mtlmice0_sum_h1.75$Categorical, 
                                        output_mice_sum_h1.75$Categorical,
                                        output_mice_pool_sum_h1.75$Categorical)

output_categorical_mean_h1.75 <- output_categorical_summary_h1.75 %>% 
  group_by(Task, method, type_group) %>%
  summarise(
    across(starts_with("mean"), mean, na.rm = TRUE, .names = "mean_{.col}"),
    across(starts_with("se"), mean, na.rm = TRUE, .names = "mean_{.col}")
...
output_continuous_mean_h1.75 <- output_continuous_summary_h1.75 %>% 
  group_by(Task, method, type_group) %>%
  summarise(
    across(starts_with("mean"), mean, na.rm = TRUE, .names = "mean_{.col}"),
    across(starts_with("se"), mean, na.rm = TRUE, .names = "mean_{.col}")
...
output_coeff_mean_h1.75 <- output_coeff_summary_h1.75 %>% 
  group_by(Task, method, type_group) %>%
  summarise(
    across(starts_with("mean"), mean, na.rm = TRUE, .names = "mean_{.col}"),
    across(starts_with("se"), mean, na.rm = TRUE, .names = "mean_{.col}")
...
output_coeff_mean_con_h1.75 <- output_coeff_summary_h1.75 %>% 
  group_by(Task, method, type_group) %>%
  filter(Variable == "ic_x1" | Variable == "ic_x2" ) %>%
  summarise(
    across(starts_with("mean"), mean, na.rm = TRUE, .names = "mean_{.col}"),
...
output_coeff_mean_cat_h1.75 <- output_coeff_summary_h1.75 %>% 
  group_by(Task, method, type_group) %>%
  filter(Variable == "ic_x3" | Variable == "ic_x4" ) %>%
  summarise(
    across(starts_with("mean"), mean, na.rm = TRUE, .names = "mean_{.col}"),
...
h <- c(0, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75)
...
ggsave(p.continuous, file = "./results/sim_htrends_mixed_1se_continuous.pdf", width = 10, height = 8, units = "in", dpi = 300)
...
ggsave(p.continuous.rss, file = "./results/sim_htrends_mixed_1se_continuous_rss.pdf", width = 10, height = 8, units = "in", dpi = 300)
...
ggsave(p.categorical, file = "./results/sim_htrends_mixed_1se_categorical.pdf", width = 10, height = 8, units = "in", dpi = 300)
...
ggsave(p.coeff, file = "./results/sim_htrends_mixed_1se_coeff.pdf", width = 10, height = 8, units = "in", dpi = 300)
...
ggsave(p.coeff_con, file = "./results/sim_htrends_mixed_coeff_con_1se.pdf", width = 10, height = 8, units = "in", dpi = 300)
...
ggsave(p.coeff_cat, file = "./results/sim_htrends_mixed_coeff_cat_1se.pdf", width = 10, height = 8, units = "in", dpi = 300)
...
ggsave(
  p.combined,
  file = "./results/sim_htrends_mixed_combined_2x2_1se.pdf",
  width = 16,
  height = 16,
  units = "in",
  dpi = 300
